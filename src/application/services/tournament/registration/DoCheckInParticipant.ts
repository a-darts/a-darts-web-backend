...
import { DoCheckInParticipantRequestDTO } from '../../../dtos/tournament/TournamentDTOs.js';


export class DoCheckInParticipant {
    constructor(
        private readonly tournamentRepository: TournamentRepository,
        private readonly registeredParticipantRepository: RegisteredParticipantRepository,
    ) { }

    public async execute(request: DoCheckInParticipantRequestDTO): Promise<void> {
